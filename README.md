...
--template-body file:////path_to_template//cloudformation//master.yaml
...
--stack-name <envCDN> \
--capabilities=CAPABILITY_IAM \
--template-body file:////path_to_template//cloudformation//infrastructure//webapp-cdn.yaml
...
dev:
  ...
  ASMAX: '2'
  ASDES: '2'
  WEBDOMAIN: "dev.cookies.com"
  CDNDOMAIN: "devel.cookies.com"

staging:
  ASMIN: '2'
  ASMAX: '2'
  ASDES: '2'
  WEBDOMAIN: "staging.cookies.com"
  CDNDOMAIN: "static.cookies.com"

prod:
  ASMIN: '2'
  ASMAX: '5'
  ASDES: '2'
  WEBDOMAIN: "www.cookies.com"
  CDNDOMAIN: "cdn.cookies.com"
